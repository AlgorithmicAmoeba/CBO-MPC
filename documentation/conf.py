...
sys.path.append(os.path.abspath('/home/ex/Documents/Hons/CBO/project'))
sys.path.append(os.path.abspath('/home/ex/Documents/Hons/CBT/Skogestad-Python'))
